// -----------------------------------------------------------------------
// <copyright file="GetCustomerGroup1SubscribedSkus.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.CustomerSubscribedSkus
{
    ...
    /// </summary>
    internal class GetCustomerGroup1SubscribedSkus : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Customer Group1 Subscribed Skus"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            if (customersBatch != null)
            {
                ...
                foreach (var customer in customersBatch)
                {
                    ...
                    // get customer user Group1 subscribed skus information.
                ...
                {
                    Console.Out.WriteLine("No Customer is having Group1 Subscribed Sku.");
                }
            }
        }
    }
