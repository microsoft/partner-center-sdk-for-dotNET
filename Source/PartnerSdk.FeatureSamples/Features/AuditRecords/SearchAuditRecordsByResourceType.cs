// <copyright file="SearchAuditRecordsByResourceType.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Invoices
{
    ...
    /// </summary>
    internal class SearchAuditRecordsByResourceType : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Search Audit Records by Resource Type"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var filter = new SimpleFieldFilter(AuditRecordSearchField.ResourceType.ToString(), FieldFilterOperation.Equals, ResourceType.Order.ToString());
