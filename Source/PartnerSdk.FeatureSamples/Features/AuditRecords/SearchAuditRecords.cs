// <copyright file="SearchAuditRecords.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Invoices
{
    ...
    /// </summary>
    internal class SearchAuditRecords : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Search Audit Records by Customer Name"; }
        }
