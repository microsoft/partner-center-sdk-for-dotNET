// <copyright file="GetUsageLineItemsForOpenPeriodPaging.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Invoices
{
    ...
    /// <summary>
    /// Showcases unbilled consumption line items paging.
    /// Marketplace Usage Consumption
    /// </summary>
    internal class GetUsageLineItemsForOpenPeriodPaging : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Unbilled - Consumption - Reconciliation Line Items Paging"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            Console.Out.WriteLine("\t/v1/invoices/unbilled/lineitems?provider=marketplace&invoicelineitemtype=usagelineitems&currencycode={CurrencyCode}&period={Period}&size={Size}");
            Console.Out.WriteLine(" ");
