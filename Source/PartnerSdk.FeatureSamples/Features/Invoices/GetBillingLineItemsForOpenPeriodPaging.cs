...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Invoices
{
    ...
    /// <summary>
    /// Showcases unbilled reconciliation line items paging.
    /// First Party, Marketplace reconciliation line items
    /// </summary>
    internal class GetBillingLineItemsForOpenPeriodPaging : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Unbilled - First Party & Marketplace - Reconciliation Line Items Paging"; }
        }
        ...
        public static void PrintProperties(InvoiceLineItem item)
        {
            ...
            else if (item is OneTimeInvoiceLineItem)
            {
                ...
                Console.Out.WriteLine(" ");
                Console.Out.WriteLine("\tFirst Party And Marketplace Reconciliation Line Items: ");
            }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            Console.Out.WriteLine("\t/v1/invoices/unbilled/lineitems?provider=all&invoicelineitemtype=billinglineitems&currencycode={CurrencyCode}&period={Period}&size={Size}");
            Console.Out.WriteLine(" ");
            ...
            var seekBasedResourceCollection = scopedPartnerOperations.Invoices.ById("unbilled").By("all", "billinglineitems", curencyCode, period, pageMaxSizeReconciliationLineItems).Get();
