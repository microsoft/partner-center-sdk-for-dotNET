// -----------------------------------------------------------------------
// <copyright file="CancelNewCommerceMigrationSchedule.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.NewCommerceMigrationSchedules
{
    ...
    /// </summary>
    internal class CancelNewCommerceMigrationSchedule : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Cancel a New-Commerce migration schedule"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            Console.Out.WriteLine();
            Console.Out.WriteLine("Enter NewCommerceMigrationScheduleId to cancel");
            ...
            Console.Out.WriteLine("Cancelling the New-Commerce migration schedule...\n");
            var updatedNewCommerceSchedule = customerOperations.NewCommerceMigrationSchedules.ById(selectedNewCommerceMigrationSchedule.Id).Cancel();

            Console.Out.WriteLine("Successfully cancelled the New-Commerce migration schedule!\n");
