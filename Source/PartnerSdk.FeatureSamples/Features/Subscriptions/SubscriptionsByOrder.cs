// <copyright file="SubscriptionsByOrder.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Subscriptions
{
    ...
    /// <summary>
    /// Displays subscriptions which belong to an order.
    /// </summary>
    internal class SubscriptionsByOrder : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Order Subscriptions"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            ResourceCollection<Subscription> customerSubscriptions = partnerOperations.Customers.ById(selectedCustomerId).Subscriptions.ByOrder("Some order Id").Get();
