// <copyright file="PartnerServiceRequestsSimpleQuerySearch.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.ServiceRequests
{
    ...
    /// </summary>
    internal class PartnerServiceRequestsSimpleQuerySearch : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get
            {
                return "Search Partner Service Request: Simple Query Type";
            }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var serviceRequests = scopedPartnerOperations.ServiceRequests.Query(QueryFactory.Instance.BuildSimpleQuery());
