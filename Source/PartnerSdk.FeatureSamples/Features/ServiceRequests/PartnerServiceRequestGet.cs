// <copyright file="PartnerServiceRequestGet.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.ServiceRequests
{
    ...
    /// </summary>
    internal class PartnerServiceRequestGet : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get
            {
                return "Get Partner Service Request";
            }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            // test loc tenant id : cf177721-b2c0-42df-a09c-a3c7d99e31c9
            if (existingServiceRequest != null)
            {
                ServiceRequest serviceRequest = partnerOperations.ServiceRequests.ById(existingServiceRequest.Id).Get();
