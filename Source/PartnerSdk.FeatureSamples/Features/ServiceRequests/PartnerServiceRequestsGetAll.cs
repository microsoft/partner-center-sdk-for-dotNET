// <copyright file="PartnerServiceRequestsGetAll.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.ServiceRequests
{
    ...
    /// </summary>
    internal class PartnerServiceRequestsGetAll : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get
            {
                return "Get All Partner Service Requests";
            }
        }
