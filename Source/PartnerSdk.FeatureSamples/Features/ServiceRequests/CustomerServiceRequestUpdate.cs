// <copyright file="CustomerServiceRequestUpdate.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.ServiceRequests
{
    ...
    /// </summary>
    internal class CustomerServiceRequestUpdate : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get
            {
                return "Update Customer Service Request";
            }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            ServiceRequest updatedServiceRequest = partnerOperations.Customers.ById(customerId)
