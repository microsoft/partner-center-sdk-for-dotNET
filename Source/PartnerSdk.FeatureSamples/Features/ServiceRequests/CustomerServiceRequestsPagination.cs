// <copyright file="CustomerServiceRequestsPagination.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.ServiceRequests
{
    ...
    /// </summary>
    internal class CustomerServiceRequestsPagination : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get
            {
                return "Search Customer Service Request: Pagination";
            }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var serviceRequestsBatch = scopedPartnerOperations.Customers.ById(customerId).ServiceRequests.Query(QueryFactory.Instance.BuildIndexedQuery(3));
