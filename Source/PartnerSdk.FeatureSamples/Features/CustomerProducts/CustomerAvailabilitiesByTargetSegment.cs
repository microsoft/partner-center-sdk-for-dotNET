// -----------------------------------------------------------------------
// <copyright file="CustomerAvailabilitiesByTargetSegment.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.CustomerProducts
{
    ...
    /// <summary>
    /// Showcases getting customer availabilities by target segment.
    /// </summary>
    internal class CustomerAvailabilitiesByTargetSegment : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Availabilities For Customer By Target Segment"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var availabilities = partnerOperations.Customers.ById(customerId).Products.ById(products[0].Id).Skus.ById(skus[0].Id).Availabilities.ByTargetSegment("commercial").Get();
