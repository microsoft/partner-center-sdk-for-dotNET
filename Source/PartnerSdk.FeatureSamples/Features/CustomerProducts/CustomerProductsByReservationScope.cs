// <copyright file="CustomerProductsByReservationScope.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.CustomerProducts
{
    ...
    /// <summary>
    /// Showcases getting products by customer id and target view and reservation scope.
    /// </summary>
    internal class CustomerProductsByReservationScope : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Products By Customer Id And Reservation Scope"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            ResourceCollection<Product> products = partnerOperations.Customers.ById(customerId).Products.ByTargetView(targetView).ByReservationScope("AzurePlan").Get();
