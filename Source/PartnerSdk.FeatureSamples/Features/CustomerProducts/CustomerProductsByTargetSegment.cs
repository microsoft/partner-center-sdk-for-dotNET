// <copyright file="CustomerProductsByTargetSegment.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.CustomerProducts
{
    ...
    /// <summary>
    /// Showcases getting products by customer id and target view, filtered by target segment.
    /// </summary>
    internal class CustomerProductsByTargetSegment : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Products By Customer Id, Collection Id And Segment"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            ResourceCollection<Product> products = partnerOperations.Customers.ById(customerId).Products.ByTargetView(targetView).ByTargetSegment("commercial").Get();
