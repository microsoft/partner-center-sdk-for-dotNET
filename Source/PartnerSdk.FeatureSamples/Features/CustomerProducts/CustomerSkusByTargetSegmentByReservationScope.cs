// -----------------------------------------------------------------------
// <copyright file="CustomerSkusByTargetSegmentByReservationScope.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.CustomerProducts
{
    ...
    /// <summary>
    /// Showcases getting skus for a product by customer id, target segment, and reservation scope.
    /// </summary>
    internal class CustomerSkusByTargetSegmentByReservationScope : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Skus For Customer By Target Segment By Reservation Scope"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var skus = partnerOperations.Customers.ById(customerId).Products.ById(productId).Skus.ByTargetSegment("commercial").ByReservationScope("AzurePlan").Get();
