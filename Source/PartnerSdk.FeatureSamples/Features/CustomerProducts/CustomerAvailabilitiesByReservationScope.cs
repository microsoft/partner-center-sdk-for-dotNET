// -----------------------------------------------------------------------
// <copyright file="CustomerAvailabilitiesByReservationScope.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.CustomerProducts
{
    ...
    /// </summary>
    internal class CustomerAvailabilitiesByReservationScope : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Availabilities For Customer By Reservation Scope"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var availabilities = partnerOperations.Customers.ById(customerId).Products.ById(productId).Skus.ById(skuId).Availabilities.ByReservationScope("AzurePlan").Get();
