// -----------------------------------------------------------------------
// <copyright file="GetCustomerBillingProfile.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Profiles
{
    ...
    /// <summary>
    /// Showcases getting a customer's billing profile.
    /// </summary>
    internal class GetCustomerBillingProfile : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Customer Billing Profile"; }
        }
