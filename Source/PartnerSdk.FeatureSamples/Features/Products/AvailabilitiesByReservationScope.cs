// -----------------------------------------------------------------------
// <copyright file="AvailabilitiesByReservationScope.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Products
{
    ...
    /// </summary>
    internal class AvailabilitiesByReservationScope : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Availabilities By Reservation Scope"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var availabilities = partnerOperations.Products.ByCountry("US").ById(productId).Skus.ById(skuId).Availabilities.ByReservationScope("AzurePlan").Get();
