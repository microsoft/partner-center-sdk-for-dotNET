// -----------------------------------------------------------------------
// <copyright file="Skus.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Products
{
    ...
    /// <summary>
    /// Showcases getting skus for a product.
    /// </summary>
    internal class Skus : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Skus For Product"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var skus = partnerOperations.Products.ByCountry("US").ById(products[0].Id).Skus.Get();
            ...
            state.Add(FeatureSamplesApplication.SkusKey, new List<Sku>(skus.Items));
        }
    }
}
