// <copyright file="ProductsByReservationScope.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Products
{
    ...
    /// <summary>
    /// Showcases products by reservation s cope.
    /// </summary>
    internal class ProductsByReservationScope : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Products by country, target view, and reservation scope"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            ResourceCollection<Product> products = partnerOperations.Products.ByCountry("US").ByTargetView(targetView).ByReservationScope("AzurePlan").Get();
            ...
            // store the products into the application state
            state.Add(FeatureSamplesApplication.ProductsKey, new List<Product>(products.Items));
        }
    }
}
