// <copyright file="Products.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Products
{
    ...
    /// Showcases products.
    /// </summary>
    internal class Products : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Products by country and target view"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            ResourceCollection<Product> products = partnerOperations.Products.ByCountry("US").ByTargetView(targetView).Get();
