// -----------------------------------------------------------------------
// <copyright file="SkusByTargetSegmentByReservationScope.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Products
{
    ...
    /// <summary>
    /// Showcases getting skus for a product by target segment by reservation scope.
    /// </summary>
    internal class SkusByTargetSegmentByReservationScope : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Skus For Product By Target Segment By Reservation Scope"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            var skus = partnerOperations.Products.ByCountry("US").ById(productId).Skus.ByTargetSegment("commercial").ByReservationScope("AzurePlan").Get();
