// <copyright file="ProductsByTargetSegmentByReservationScope.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.Products
{
    ...
    /// Showcases products.
    /// </summary>
    internal class ProductsByTargetSegmentByReservationScope : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Products by country, target view, target segment, and reservation scope"; }
        }
        ...
        public void Execute(IAggregatePartner partnerOperations, IDictionary<string, object> state)
        {
            ...
            ResourceCollection<Product> products = partnerOperations.Products.ByCountry("US").ByTargetView(targetView).ByTargetSegment("commercial").ByReservationScope("AzurePlan").Get();
