// -----------------------------------------------------------------------
// <copyright file="GetAzureSharedRateCard.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.FeatureSamples.Features.RateCards
{
    ...
    /// </summary>
    internal class GetAzureSharedRateCard : IUnitOfWork
    {
        /// <summary>
        ...
        public string Title
        {
            get { return "Get Azure shared rate card"; }
        }
        ...
        {
            var azureRateCard = partnerOperations.RateCards.Azure.GetShared("USD", "US");
