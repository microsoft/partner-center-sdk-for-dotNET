// -----------------------------------------------------------------------
// <copyright file="BaseQuery.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.Models.Query
{
    ...
    internal abstract class BaseQuery : IQuery
    {
        ...
        public virtual FieldFilter Filter
        {
            get
            {
                throw new InvalidOperationException("Filter is not supported.");
            }
        ...
        public virtual Sort Sort
        {
            get
            {
                throw new InvalidOperationException("Sort is not supported.");
            }
        ...
        public virtual int Index
        {
            get
            {
                throw new InvalidOperationException("Index is not supported.");
            }
        ...
        public virtual int PageSize
        {
            get
            {
                throw new InvalidOperationException("PageSize is not supported.");
            }
        ...
        public virtual SeekOperation SeekOperation
        {
            get
            {
                throw new InvalidOperationException("SeekOperation is not supported.");
            }
