// -----------------------------------------------------------------------
// <copyright file="Offer.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.Models.Offers
{
    ...
    public sealed class Offer : ResourceBaseWithLinks<OfferLinks>
    {
        ...
        /// </summary>
        public OfferAttestationProperties AttestationProperties { get; set; }

        #region Product purchase information
