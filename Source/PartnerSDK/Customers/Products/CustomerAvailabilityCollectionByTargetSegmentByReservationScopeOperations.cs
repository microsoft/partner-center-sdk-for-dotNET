// -----------------------------------------------------------------------
// <copyright file="CustomerAvailabilityCollectionByTargetSegmentByReservationScopeOperations.cs" company="Microsoft Corporation">
...
namespace Microsoft.Store.PartnerCenter.Customers.Products
{
    ...
    internal class CustomerAvailabilityCollectionByTargetSegmentByReservationScopeOperations : BasePartnerComponent<Tuple<string, string, string, string, string>>, IAvailabilityCollectionByTargetSegmentByReservationScopeOperations
    {
        ...
        public async Task<ResourceCollection<Availability>> GetAsync()
        {
            ...
            partnerServiceProxy.UriParameters.Add(new KeyValuePair<string, string>(
                PartnerService.Instance.Configuration.Apis.GetAvailabilities.Parameters.ReservationScope, this.Context.Item5));
